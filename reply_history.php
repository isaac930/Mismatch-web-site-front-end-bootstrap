...
<hr>
<a href="delete_reply?token=<?php echo $token; ?>&id=<?php echo $replyreturned->id; ?>&usertype=<?php echo $usertype;?>&email=<?php echo $replyreturned->email;?>">
 <ty style="color:success;">DELETE REPLY</ty>
</a>
