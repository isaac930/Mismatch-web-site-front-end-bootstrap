...
?>
  ...
  ?>
                ...
                <div class="container-fluid">
                    ...
                    <h4 style="color:success;">SEND CHAT REQUEST</h4>
...
$chatment_name = $_POST['chatment_name'];

// User data to send using HTTP PUT method in curl
$data = array('chatment_name'=> $chatment_name, 'chatment_email' => $chatment_email);
...
$url = "https://powerful-cliffs-24132.herokuapp.com/api/auth/chatrequest";
...
<div class="alert alert-success" role="alert">
<?php
header("Location:dashboard?token=$token&usertype=$usertype&message=$message&email=$email");
?>
</div>
...
<form class="user" name="add_chat_request" id="form" action="add_chat_request?token=<?php echo $token; ?>&usertype=<?php echo $usertype; ?>&email=<?php echo $email;?>&chatment_name=<?php echo $chatment_name; ?>&chatment_email=<?php echo $chatment_email; ?>" method="post" role="form">

<div class="form-group">
<div class="col-sm-12 mb-3 mb-sm-0">
<input type="hidden" name="chatment_name" class="form-control form-control-user"
id="exampleInputPassword" placeholder="Enter chatment name" required="" 
value="<?php echo $chatment_name; ?>"
readonly=""
/>
                            <div class="form-group">
<div class="col-sm-12 mb-3 mb-sm-0">
...
/>
                                ...
                                <input type="submit" name ="save" value="SEND CHAT REQUEST" class="btn btn-primary btn-user btn-block"> 
