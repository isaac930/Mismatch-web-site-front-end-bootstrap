...
$chatment_image_path = $_GET['chatment_image_path'];
            ...
            <div id="content">
                ...
                <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                    ...
                    <button id="sidebarToggleTop" class="btn btn-link d-md-none rounded-circle mr-3">
                     ...
                     <!-- Topbar Search -->
                   <marquee scrolldelay="130"><h5 style="color:red;">This is mismatch dating app </strong>which is consuming a backend in laravel,This front end just hits the end points</h5></marquee>
...
?>
  ...
  ?>
                ...
                <div class="container-fluid">
                    ...
                    <h4 style="color:success;">CHATS REPLIES</h4>
                    </div> 

                    <hr>

<h6 style="color:success;">
<a href ="reply_history?token=<?php echo $token; ?>&usertype=<?php echo $usertype; ?>&email=<?php echo $email;?>">View All replies you have made</a>
</h6>
...
$image_path1 = $_POST['image_path'];
$chatment_image_path1 = $_POST['chatment_image_path'];

$url_path = 'https://powerful-cliffs-24132.herokuapp.com/api/auth/chats_reply';
...
$data = array('chatment_email' => $chatment_email,
 'post_reply' => $reply,
 'post_id' => $editid,
 'image_path' => $image_path1,
 'chatment_image_path' => $chatment_image_path1
);
...
{
//this is block to update chat status

// User data to send using HTTP PUT method in curl
    $data = array('chat_id'=> $editid);
    
    // Data should be passed as json format
    $data_json = json_encode($data);
    
    $url = "https://powerful-cliffs-24132.herokuapp.com/api/auth/update_chat_post_status";
...
//block to update chat status ends here
}
?>
...
<?php
   ...
   header("Location:add_reply?token=$token&usertype=$usertype&message=$message&email=$chatment_email");
...
<div class="alert alert-success" role="alert">
                            ...
                            <form class="user" name="add_reply" id="form" action="add_reply?token=<?php echo $token; ?>&usertype=<?php echo $usertype; ?>&email=<?php echo $email;?>" method="post" role="form">

                            <div class="form-group">
<div class="col-sm-12 mb-3 mb-sm-0">
<input type="hidden" name="edit_id" class="form-control form-control-user"
id="exampleInputPassword" placeholder="Enter edit id" required="" 
value="<?php echo $id; ?>"
readonly=""
/>
<hr>
...
<div class="form-group">
<div class="col-sm-12 mb-3 mb-sm-0">
<input type="hidden" name="image_path" class="form-control form-control-user"
id="exampleInputPassword" placeholder="path" required="" 
...
<div class="form-group">
<div class="col-sm-12 mb-3 mb-sm-0">
<input type="hidden" name="chatment_image_path" class="form-control form-control-user"
id="exampleInputPassword" placeholder="path" required="" 
value="<?php echo $chatment_image_path; ?>"
readonly=""
/>
...
<div class="form-group">
<div class="col-sm-12 mb-3 mb-sm-0">
<textarea name="post"  class="form-control form-control-user" id="exampleInputPassword" placeholder="Post To Reply To" required="" readonly=""><?php echo $post ?></textarea>

<hr>

<div class="form-group">
<div class="col-sm-12 mb-3 mb-sm-0">
<textarea name="reply" class="form-control form-control-user"
id="exampleInputPassword" placeholder="Enter reply" required="">
</textarea>
                                    </div>
                                ...
                                <hr>
                                <input type="submit" name ="save" value="POST REPLY" class="btn btn-primary btn-user btn-block"> 
...
$url = "https://powerful-cliffs-24132.herokuapp.com/api/auth/chats_reply";
