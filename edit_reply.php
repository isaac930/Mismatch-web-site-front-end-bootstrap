...
?>
  ...
  ?>
                ...
                <div class="container-fluid">
                    ...
                    <h4 style="color:success;">EDIT REPLY</h4>
...
$editedreply = $_POST['reply'];

// User data to send using HTTP PUT method in curl
$data = array('chatment_email'=> $chatmail,
 'reply_post' => $editedreply,
 'post_id' => $editid);
...
$url = "https://stormy-cove-15358.herokuapp.com/api/auth/chats_reply/$editid";
...
<?php
if($response){
    $message = "Chat Reply Updated Successfully";
?>
...
header("Location:reply_history?token=$token&usertype=$usertype&message=$message&email=$email");
?>
</div>
...
<form class="user" name="edit_reply" id="form" action="edit_reply?token=<?php echo $token; ?>&usertype=<?php echo $usertype; ?>&email=<?php echo $email;?>&id=<?php echo $id;?>&reply=<?php echo $reply; ?>" method="post" role="form">

                            <div class="form-group">
<div class="col-sm-12 mb-3 mb-sm-0">
<input type="text" name="edit_id" class="form-control form-control-user"
id="exampleInputPassword" placeholder="Enter id of reply to edit" required="" 
value="<?php echo $id; ?>"
readonly=""
/>
<hr>
...
id="exampleInputPassword" placeholder="Enter reply" required=""><?php echo $reply; ?></textarea>
                                    </div>
