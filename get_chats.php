...
?>
 ...
 <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">MY CHAT POST HISTORY</h6>
            ...
            <tr class="table-danger">
                ...
                <td scope="col">CHATMENT EMAIL</td>
                <td scope="col">CHATMENT NAME</td>
                <td scope="col">CHATMENT CONTACT</td>
...
$url = "https://powerful-cliffs-24132.herokuapp.com/api/auth/chats";
...
foreach ($chat_data as $chat) {
    echo "<tr>";
    echo '<td>'.$chat->id.'</td>';
	echo '<td>'.$chat->date.'</td>';
    echo '<td>'.$chat->name.'</td>';
    echo '<td>'.$chat->email.'</td>';
    echo '<td>'.$chat->contact.'</td>';
    echo '<td>'.$chat->chatment_email.'</td>';
    echo '<td>'.$chat->chatment_name.'</td>';
    echo '<td>'.$chat->chatment_contact.'</td>';
    echo '<td>'.$chat->post.'</td>';
  
?> 
 <td><a href="edit_chat?id=<?php echo $chat->id ?>&token=<?php echo $token; ?>&usertype=<?php echo $usertype; ?>&email=<?php echo $email ;?>&post=<?php echo $chat->post; ?>">
     <button type="button" class="btn btn-danger">Edit</button>
    </a></td>

    <td><a href="delete_chat?id=<?php echo $chat->id ?>&token=<?php echo $token; ?>&usertype=<?php echo $usertype; ?>&email=<?php echo $email ;?>">
