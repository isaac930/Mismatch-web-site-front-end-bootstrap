...
?>
 ...
 <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-success">LIST OF PROFILES </h6>
                        </div>
                        <div class="card-body">
...
foreach ( $profilearray as $loggedinprofile ) {
...
$url = "https://powerful-cliffs-24132.herokuapp.com/api/auth/profiles"; //api meal get end point
...
$profile_data = $response_data->profiles;
...
?>
  ...
  <img src="<?php echo $baseurl.$profile->image_path; ?>" width="200" height="200" class="rounded-circle" alt="profile-picture" border="0" />
   
   <div class="alert alert-success"  role="alert">
   <xy class="font-weight-bold">Name: <?php echo $profile->name; ?> </xy>  
   
</div>  

<div class="alert alert-success"  role="alert">
   <xy class="font-weight-bold">Email: <?php echo $profile->email; ?> </xy> 
</div>

 <div class="alert alert-success"  role="alert">  
   <xy class="font-weight-bold">Contact: <?php echo $profile->contact; ?> </xy> 
</div>   
 
<div class="alert alert-success"  role="alert">
   <xy class="font-weight-bold">Age: <?php echo $profile->age; ?> </xy> 
</div>

<div class="alert alert-success"  role="alert">
   <xy class="font-weight-bold">Location: <?php echo $profile->location; ?> </xy> 
</div>

<div class="alert alert-success"  role="alert">
   <xy class="font-weight-bold">Place of birth: <?php echo $profile->place_of_birth; ?> </xy> 
</div>

<div class="alert alert-success"  role="alert">
   <xy class="font-weight-bold">Occupation: <?php echo $profile->occupation; ?> </xy> 
</div>

<div class="alert alert-success"  role="alert">
   <xy class="font-weight-bold">Likes: <?php echo $profile->likes; ?> </xy> 
</div>

<div class="alert alert-success"  role="alert">
   <xy class="font-weight-bold">Dislikes: <?php echo $profile->dislikes; ?></xy> 
</div>

<div class="alert alert-success"  role="alert">
   <xy class="font-weight-bold">Gender: <?php echo $profile->gender; ?> </xy> 
</div>

<div class="alert alert-success"  role="alert">
   <xy class="font-weight-bold">Searching Status: <?php echo $profile->searching_status; ?> </xy> 
</div>

    <div class="alert alert-danger"  role="alert">
   <xy class="font-weight-bold">
   <a href="add_chat_request?id=<?php echo $profile->id ?>&token=<?php echo $token; ?>&usertype=<?php echo $usertype; ?>&chatment_name=<?php echo $profile->name; ?>&email=<?php echo $profile->email ;?>&my_email=<?php echo $loggedinprofile->email; ?>&age=<?php echo $profile->age ;?>&location=<?php echo $profile->location ;?>&place_of_birth=<?php echo $profile->place_of_birth ;?>&occupation=<?php echo $profile->occupation ;?>&likes=<?php echo $profile->likes ;?>&dislikes=<?php echo $profile->dislikes ;?>&gender=<?php echo $profile->gender ;?>&searching_status=<?php echo $profile->searching_status ;?>">
       Send Chat Request:
</a>
</xy> 
</div>
...
}// ends for loop for currently logged in user, the for loop is above
?>
                    <!-- Content Row -->
                    <div class="row">
