...
$url_path = "https://powerful-cliffs-24132.herokuapp.com/api/auth/chats/$id";
...
header("Location:add_chat?token=$token&usertype=$usertype&email=$email&message=$message");
?> 
</div>
                                </div>
                            </div>
