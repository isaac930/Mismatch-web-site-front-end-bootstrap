...
?>
 ...
 <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">ALL REPLIES I HAVE MADE TO MY CHATMENTS</h6>
...
$url = "https://stormy-cove-15358.herokuapp.com/api/auth/allchats";
...
$reply_data = $response_data->allchats;
...
foreach ($reply_data as $reply) {
    ...
    echo '<td>'.$reply->email.'</td>';
    echo '<td>'.$reply->contact.'</td>';
    echo '<td>'.$reply->chatment_email.'</td>';
    echo '<td>'.$reply->chatment_name.'</td>';
    echo '<td>'.$reply->chatment_contact.'</td>';
    echo '<td>'.$reply->post.'</td>';
    echo '<td>'.$reply->reply_post.'</td>';
