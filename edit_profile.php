...
$gender = $_GET['gender'];
$searching_status = $_GET['searching_status'];
...
?>
  ...
  ?>
                ...
                <div class="container-fluid">
                    ...
                    <h4 style="color:success;">EDIT PROFILE</h4>
...
$url = "https://powerful-cliffs-24132.herokuapp.com/api/auth/profiles/$editid";
...
<div class="alert alert-success" role="alert">
                            ...
                            <form class="user" name="edit_profile" id="form" action="edit_profile?token=<?php echo $token; ?>&usertype=<?php echo $usertype; ?>&email=<?php echo $email;?>" method="post" role="form">

                            <div class="form-group">
<div class="col-sm-12 mb-3 mb-sm-0">
<input type="hidden" name="edit_id" class="form-control form-control-user"
id="exampleInputPassword" placeholder="Enter Profile Id" required=""
...
id="exampleInputPassword" required="">
<option><?php echo $searching_status; ?></option>
...
<hr>
<input type="submit" name ="update" value="UPDATE PROFILE" class="btn btn-primary btn-user btn-block"> 
