...
?>
 ...
 <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">CHAT POSTS TO REPLY TO</h6>
...
$url = "https://powerful-cliffs-24132.herokuapp.com/api/auth/chats_to_reply_to";
...
<img src="<?php echo $baseurl.$chat->image_path?>" width="70" height="70" class="rounded-circle float-left" alt="profile-picture" border="0" />
&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;

   <xy class="font-weight-bold">
   <?php echo $chat->name; ?> 
<hr>
   <?php echo $chat->post; ?> </xy> 
   <hr>
   <a href="add_reply?id=<?php echo $chat->id ?>&token=<?php echo $token; ?>&usertype=<?php echo $usertype; ?>&email=<?php echo $chat->email ;?>&post=<?php echo $chat->post; ?>&image_path=<?php echo $chat->image_path; ?>&chatment_image_path=<?php echo $chat->chatment_image_path; ?>">
