...
<center>
 ...
 <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-success">LIST OF PEOPLE YOU SENT CHAT REQUEST</h6>
                        </div>
                        <div class="card-body">
...
$url = "https://powerful-cliffs-24132.herokuapp.com/api/auth/allowedchats"; 
...
?>
  ...
  <img src="<?php echo $baseurl.$chatrequest->chatment_image_path; ?>" width="200" height="200" class="rounded-circle" alt="profile-picture" border="0" />
   
   <div class="alert alert-success"  role="alert">
   <xy class="font-weight-bold">Name: <?php echo $chatrequest->chatment_name; ?> </xy>  
   
</div>  

<div class="alert alert-danger"  role="alert">
   <xy class="font-weight-bold">
   <a href="add_chat?id=<?php echo $chatrequest->id ?>&token=<?php echo $token; ?>&usertype=<?php echo $usertype; ?>&chatment_name=<?php echo $chatrequest->chatment_name; ?>&email=<?php echo $chatrequest->chatment_email ;?>&my_email=<?php echo $chatrequest->email; ?>">
       Chat
</a>
</xy> 
</div>
