...
?>
  ...
  ?>
                ...
                <div class="container-fluid">
                    ...
                    <h6 style="color:success;">PROFILE SETUP</h6>
        
                    </div> 
                    <hr>
<div class="alert alert-danger" role="alert">
<a href="get_my_full_profile?token=<?php echo $token;?>&usertype=<?php echo $usertype;?>&email=<?php echo $email; ?>&message=<?php echo $message; ?>">
VIEW YOUR PROFILE
</a>
</div>
<hr>
...
$gender = $_POST['gender'];
$searching_status = $_POST['searching_status'];

$url_path = 'https://powerful-cliffs-24132.herokuapp.com/api/auth/profiles';
...
<?php
if($message){
   header("Location:get_my_full_profile?token=$token&usertype=$usertype&email=$email&message=$message");
}
?>
...
<div class="alert alert-success" role="alert">
                            ...
                            <form class="user" name="add_profile" id="form" action="add_profile?token=<?php echo $token; ?>&usertype=<?php echo $usertype; ?>&email=<?php echo $email;?>" method="post" role="form">


                            <div class="form-group">
<div class="col-sm-12 mb-3 mb-sm-0">
<input type="text" name="age" class="form-control form-control-user"
id="exampleInputPassword" placeholder="Enter Your Age" required=""/>
</div>
...
id="exampleInputPassword" placeholder="Enter Your Location" required=""/>
</div>
...
<div class="form-group">
<div class="col-sm-12 mb-3 mb-sm-0">
<input type="text" name="place_of_birth" class="form-control form-control-user"
id="exampleInputPassword" placeholder="Enter Your Place Of Birth" required=""/>
</div>
...
<div class="form-group">
<div class="col-sm-12 mb-3 mb-sm-0">
<input type="text" name="occupation" class="form-control form-control-user"
id="exampleInputPassword" placeholder="Enter Your Occupation" required=""/>
</div>
...
<div class="form-group">
<div class="col-sm-12 mb-3 mb-sm-0">
<input type="text" name="likes" class="form-control form-control-user"
id="exampleInputPassword" placeholder="Enter Your likes" required=""/>
</div>
...
<div class="form-group">
<div class="col-sm-12 mb-3 mb-sm-0">
<input type="text" name="dislikes" class="form-control form-control-user"
id="exampleInputPassword" placeholder="Enter Your Dislikes" required=""/>
</div>
...
<div class="form-group">
<div class="col-sm-12 mb-3 mb-sm-0">
<select name="searching_status" class="form-control"
id="exampleInputPassword" required="">
<option>Select Your Status</option>
<option>Single and searching</option>
<option>Married but searching</option>
<option>Devoced and searching</option>
<option>Lost my lover searching for a new one</option>
</select>
</div>
...
<hr>
<input type="submit" name ="save" value="ADD PROFILE" class="btn btn-primary btn-user btn-block"> 
