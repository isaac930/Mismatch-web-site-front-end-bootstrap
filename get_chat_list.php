...
?>
 ...
 <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-success">LIST OF PEOPLE WHICH SENT YOU CHAT REQUEST </h6>
                        </div>
                        <div class="card-body">
...
<div class="alert alert-danger"  role="alert">
   ...
   <a href="approvechat?id=<?php echo $chatrequest->id ?>&token=<?php echo $token; ?>&usertype=<?php echo $usertype; ?>&chatment_name=<?php echo $chatrequest->chatment_name; ?>&email=<?php echo $chatrequest->chatment_email ;?>&my_email=<?php echo $loggedinprofile->email; ?>">
       Accept Chat Request
</a>
</xy> 
</div>
