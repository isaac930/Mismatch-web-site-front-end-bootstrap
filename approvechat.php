...
$url_path = "https://powerful-cliffs-24132.herokuapp.com/api/auth/chatrequest/$id";
...
header("Location:dashboard?token=$token&usertype=$usertype&email=$email&my_email=$my_email&chatment_name=$chatment_name&chatment_email=$chatment_email&message=$message");
?> 
</div>
                                </div>
                            </div>
